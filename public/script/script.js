window.onload = function(){
    const socket = io('https://whatchatweb.herokuapp.com/'); //NOTE: URL CHANGES FOR DEPLOYMENT! LOCALHOST FOR TESTING PURPOSES ONLY https://whatchatweb.herokuapp.com/ http://localhost:3000/
